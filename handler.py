...
def log_to_event(log):
    ...
    ev = {
        ...
        "xforwarded_for": log["x-forwarded-for"] if log["x-forwarded-for"] != "-" else None,
        ...
        "c-port": log["c-port"] if log["c-port"] != "-" else None,
        "time_to_first_byte": log["time-to-first-byte"] if log["time-to-first-byte"] != "-" else None,
        "x-edge-detailed-result-type": log["x-edge-detailed-result-type"] if log["x-edge-detailed-result-type"] != "-" else None,
        "content-type": log["sc-content-type"] if log["sc-content-type"] != "-" else None,
        "content-len": log["sc-content-len"] if log["sc-content-len"] != "-" else None,
        "range-start": log["sc-range-start"] if log["sc-range-start"] != "-" else None,
        "range-end": log["sc-range-end"] if log["sc-range-end"] != "-" else None,
    }
    return ev
